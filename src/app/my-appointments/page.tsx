...
export default function MyAppointmentsPage() {
  ...
  const [existingReviews, setExistingReviews] = useState<Map<number, boolean>>(
    new Map()
  );
      ...
      appointmentsList.forEach((apt) => {
        if (apt.id) {
          const hasReview = reviews.some(
            (review: any) => review.appointmentId === apt.id
          );
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div>
              ...
              <p className="text-muted mb-0">
                Xem và quản lý tất cả lịch hẹn khám của bạn
              </p>
            </div>
          </div>
              ...
              <div className="d-flex gap-2 flex-wrap align-items-center">
                ...
                <button
                  className={`btn btn-sm ${
                    !statusFilter ? "btn-primary" : "btn-outline-primary"
                  }`}
                  ...
                  <table className="table table-hover align-middle">
                    ...
                    <tbody>
                      {appointments.map((apt) => {
                        ...
                        const hasReview = apt.id
                          ? existingReviews.get(apt.id)
                          : false;
                        ...
                        return (
                          <tr key={apt.id}>
                            ...
                            <td>
                              <div className="fw-bold">
                                {apt.doctorName || `Bác sĩ #${apt.doctorId}`}
                              </div>
                  ...
                  <div className="d-flex gap-2 align-items-center">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <button
                        ...
                        style={{
                          fontSize: "2rem",
                          color: star <= reviewForm.rating ? "#ffc107" : "#ccc",
                        }}
                      >
